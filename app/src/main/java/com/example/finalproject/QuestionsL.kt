...
import com.example.finalproject.databinding.ActivityQuestionsLBinding
import com.example.finalproject.models.ConstantsL.Liyue_Questions
import com.example.finalproject.models.ConstantsL.getAllQuestionsL

class QuestionsL : AppCompatActivity() {
    private lateinit var binding: ActivityQuestionsLBinding
    override fun onCreate(savedInstanceState: Bundle?) {

        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_questions_l)

        binding = ActivityQuestionsLBinding.inflate(layoutInflater)
        ...
        val listOfQuestions = Liyue_Questions
        ...
        binding.nextButton.setOnClickListener {
            ...
            if(selectedAnswer != -1) {
                ...
                if (questionNumber == listOfQuestions.count()) {
                    ...
                    intent.putExtra("categoryName", "Liyue")
